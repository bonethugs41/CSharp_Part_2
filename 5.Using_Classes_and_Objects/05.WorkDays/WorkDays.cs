...
class WorkDays
{
    ...
    private static void CalculateWorkDays(string[] futureDateStr)
    {
        ...
        // The program calculates correctly the workdays only for furure
        // that is in the year of 2014.
        // It must be fixed to work for any future year.
        DateTime[] officialHolidays =
        {
            new DateTime(2013, 1, 1), // Нова година
            new DateTime(2013, 3, 3), // Ден на Освобождението на България от османско робство
            new DateTime(2013, 4, 18), // (Разпети петък)
            new DateTime(2013, 4, 19), // (Страстна събота)
            new DateTime(2013, 4, 20), // Великден
            new DateTime(2013, 5, 1), //  Ден на труда и на международната работническа солидарност
            new DateTime(2013, 5, 5), // Гергьовден, Ден на храбростта и Българската армия
